    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-6 py-16">
      <div className="w-full max-w-xl rounded-2xl bg-neutral-100 p-10 text-center">
        ...
        <div className="mt-6 space-y-5">
          <p className="text-base font-light leading-relaxed text-neutral-600 md:text-lg">
            お問い合わせを受け付けました。
            <br />
            内容を確認のうえ、順次ご連絡いたします。
          </p>
        ...
        <Link
          href="/"
          className="mt-8 inline-block text-base font-light text-red-500 transition-colors hover:underline"
        >
          サイトに戻る
        </Link>
      </div>
